...
<?php
/**
* esta clase es para poder acceder a los saludos de cada persona
*/
class Saludando 
{
	private $name;
	...
	public function __construct($name = 'otro nombre')
	{
		$this->name = array();
		$this->mostrar = "";
		...
		if (!isset($name)) 
		{
			$this->mostrar = "no hay a quien saludar";		
		}
		else
		{
			$this->mostrar = "bienvenido, " . $name;
		}
	}
...
*una clase padre no se puede instanciar
*/
abstract class Padre
{
	protected $hola="otro saludo desde la clase hija";
